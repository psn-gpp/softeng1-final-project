...
const Invalid_Update_Error="Invalid Update please insert missing information"
...
class InvalidUpdateError extends Error {
    ...
    constructor() {
        super()
        this.customMessage = Invalid_Update_Error
        this.customCode = 406
    }
}
...
export { UserNotFoundError, UserNotManagerError, UserNotCustomerError, UserAlreadyExistsError, UserNotAdminError, UserIsAdminError, UnauthorizedUserError,InvalidUpdateError }