...
class ProductRoutes {
    ...
    initRoutes() {
        ...
        this.router.post(
            ...
            body('model').exists({checkNull: true, checkFalsy: true}).isString().notEmpty(),
            body('category').exists({checkNull: true, checkFalsy: true}).isString().notEmpty().isIn([Category.APPLIANCE, Category.LAPTOP, Category.SMARTPHONE]),
            ...
            (req: any, res: any, next: any) => this.controller.registerProducts(req.body.model, req.body.category, req.body.quantity, req.body.details, req.body.sellingPrice, req.body.arrivalDate ? dayjs(req.body.arrivalDate).format('YYYY-MM-DD') : dayjs().format('YYYY-MM-DD'))
        ...
        this.router.patch(
            ...
            this.errorHandler.validateRequest,
            (req: any, res: any, next: any) => this.controller.changeProductQuantity(req.params.model, req.body.quantity, req.body.changeDate ? dayjs(req.body.changeDate).format('YYYY-MM-DD') : dayjs().format('YYYY-MM-DD'))
        ...
        this.router.patch(
            ...
            this.errorHandler.validateRequest,
            (req: any, res: any, next: any) => this.controller.sellProduct(req.params.model, req.body.quantity, req.body.sellingDate ? dayjs(req.body.sellingDate).format('YYYY-MM-DD') : dayjs().format('YYYY-MM-DD'))
        ...
        this.router.get(
            ...
            query('category').optional({nullable: true}).isString().isIn([Category.APPLIANCE, Category.LAPTOP, Category.SMARTPHONE]),
            query('model').optional({nullable: true}).isString().notEmpty(),
            this.errorHandler.validateRequest,
        ...
        this.router.get(
            ...
            query('category').optional({checkFalsy: true}).isString().isIn([Category.APPLIANCE, Category.LAPTOP, Category.SMARTPHONE]),
            query('model').optional({checkFalsy: true}).isString().notEmpty(),
            this.errorHandler.validateRequest,
